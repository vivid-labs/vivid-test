    ...
    >
      <div className="flex flex-shrink-0 items-start gap-2">
        <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
          <div className="h-[30px] w-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)] [rotate:-9deg]" />
      ...
      <div className="flex flex-shrink-0 items-start gap-2">
        ...
        <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
          <div
            className="h-[30px] w-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]"
            style={{
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <div className="h-[30px] w-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgb(191,_43,_43)_0%,_rgba(191,_43,_43,_0)_100%_)] [rotate:-80.6deg]" />
        <div className="h-[30px] w-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgb(191,_43,_43)_0%,_rgba(191,_43,_43,_0)_100%_)] [rotate:123.5deg]" />
        <div className="h-[30px] w-[30px] flex-shrink-0 rounded-lg bg-[rgb(191,_43,_43)] [rotate:0deg]" />
        <div className="h-[30px] w-[30px] flex-shrink-0 rounded-bl-[8px] rounded-br-[6px] rounded-tl-[2px] rounded-tr-[4px] bg-[rgb(191,_43,_43)] [rotate:0deg]" />
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <div className="relative h-[34px] w-[34px] flex-shrink-0 overflow-hidden bg-[rgb(191,_43,_43)] [rotate:36.6deg]">
          <p className="font-[Inter] text-xs font-normal text-white">T</p>
        </div>
        <div className="relative h-[34px] w-[34px] flex-shrink-0 overflow-hidden bg-[rgb(191,_43,_43)] [rotate:128.5deg]">
          <p className="font-[Inter] text-xs font-normal text-white">T</p>
        </div>
        <div className="relative h-[34px] w-[34px] flex-shrink-0 overflow-hidden bg-[rgb(191,_43,_43)] [rotate:-141.9deg]">
          <p className="font-[Inter] text-xs font-normal text-white">T</p>
        </div>
        <div className="relative h-[34px] w-[34px] flex-shrink-0 overflow-hidden bg-[rgb(191,_43,_43)] [rotate:-51.3deg]">
          <p className="font-[Inter] text-xs font-normal text-white">T</p>
        </div>
        <div className="h-[30px] w-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgb(191,_43,_43)_0%,_rgba(191,_43,_43,_0)_100%_)] [rotate:0deg]" />
        <div className="h-[30px] w-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgb(191,_43,_43)_0%,_rgba(191,_43,_43,_0)_100%_)] [rotate:50.6deg]" />
      </div>
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        <p className="whitespace-nowrap text-[8px] font-normal text-white">
          Lorem{" "}
      ...
      <div className="relative flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <img
          className="h-0 w-12 flex-shrink-0 [rotate:-37.3deg]"
          src={line_1.src}
        />
        <img
          className="h-10 w-[38px] flex-shrink-0 [rotate:25.5deg]"
          src={group_1.src}
        />
      ...
      <div className="flex flex-shrink-0 items-center gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        />
        <img
          className="h-10 w-8 flex-shrink-0 rounded-lg border border-solid border-[rgb(226,_19,_19)] object-cover opacity-80 [rotate:-9deg]"
          style={{
            boxShadow: "0px 4px 4px rgb(255, 255, 255)",
          }}
          src={flipCrop.src}
      ...
      <div className="flex flex-shrink-0 items-center gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        />
        <img
          className="h-[27px] w-[27px] flex-shrink-0 scale-x-[-100%] transform object-cover [rotate:-180deg]"
          src={flipCrop.src}
        />
        <img
          className="h-[27px] w-[27px] flex-shrink-0 object-cover [rotate:180deg]"
          src={flipCrop.src}
        />
        <div className="h-[27px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
