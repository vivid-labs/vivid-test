  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <div className="flex items-start px-[5px] py-2.5 relative w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]">
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
        </div>
        ...
        <div className="flex justify-between items-center pt-1.5 pr-2 pb-2.5 pl-1 relative w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]">
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
          <div className="overflow-hidden w-[4px] h-[4px] flex-shrink-0 bg-[rgb(255,_255,_255)]" />
        </div>
      ...
      <div className="flex items-start gap-[8px] relative flex-shrink-0">
        <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
          ...
          <div className="w-[30px] h-[30px] flex-shrink-0 bg-[rgba(191,_43,_43,_0.4)]" />
          <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(rgba(36,_0,_255,_0.2),_rgba(36,_0,_255,_0.2)),_linear-gradient(rgba(191,_43,_43,_0.4),_rgba(191,_43,_43,_0.4))]" />
        ...
        <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
          <div className="[box-shadow:0px_4px_4px_rgba(255,_255,_255,_1)] w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]" />
          <div className="filter blur-[2px] w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]" />
          <div className="[box-shadow:inset_0px_4px_4px_rgba(0,_0,_0,_1)] w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]" />
        </div>
      </div>
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(_235deg,_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[radial-gradient(_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[radial-gradient(_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[radial-gradient(_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[conic-gradient(_from_180deg,_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[conic-gradient(_from_216deg,_rgba(191,_43,_43,_1)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgba(191,_43,_43,_0.5)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[conic-gradient(_from_180deg,_rgba(36,_0,_255,_0.2)_0%,_rgba(0,_0,_0,_0)_100%_),_radial-gradient(rgba(82,_255,_0,_0.2)_0%,_rgba(216,_15,_15,_0)_100%),_linear-gradient(_180deg,_rgba(191,_43,_43,_0.5)_0%,_rgba(191,_43,_43,_0)_100%_)]" />
      </div>
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <p className="whitespace-nowrap text-justify flex flex-col justify-center bg-[linear-gradient(_180deg,_rgba(255,_0,_0,_1)_0%,_rgba(255,_255,_255,_0)_100%_),_conic-gradient(from_180deg,_rgba(0,_66,_255,_0.6)_0%,_rgba(0,_0,_0,_0)_100%),_radial-gradient(_rgba(0,_255,_41,_0.5)_0%,_rgba(0,_0,_0,_0)_100%,_rgba(0,_0,_0,_0)_100%_)] text-transparent bg-clip-text text-[8px] font-[Arial] font-normal">
          Lorem{" "}
        </p>
        <p className="whitespace-nowrap text-justify flex flex-col justify-center text-[rgb(255,_255,_255)] text-[8px] font-[Arial] font-normal">
          Lorem{" "}
        ...
        <p className="whitespace-nowrap text-justify flex flex-col justify-center text-[rgb(255,_255,_255)] text-base font-[Arial] font-normal">
          Lorem{" "}
        </p>
      ...
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(_180deg,_rgba(255,_0,_0,_0.9)_0%,_rgba(0,_0,_0,_0)_100%_)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[conic-gradient(_from_180deg,_rgba(36,_255,_0,_0.4)_0%,_rgba(0,_0,_0,_0)_100%_),_radial-gradient(rgba(82,_0,_255,_0.8)_0%,_rgba(0,_0,_0,_0)_100%),_linear-gradient(180deg,_rgba(255,_0,_0,_0.9)_0%,_rgba(0,_0,_0,_0)_100%)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[rgba(36,_255,_0,_0.79)]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(rgba(255,_0,_0,_0.49),_rgba(255,_0,_0,_0.49)),_linear-gradient(rgba(36,_255,_0,_0.79),_rgba(36,_255,_0,_0.79))]" />
        <img
          src={combo.src}
        ...
        <div className="relative w-[30px] h-[30px] flex-shrink-0 overflow-hidden">
          ...
          />
          <div className="bg-[conic-gradient(_from_180deg,_rgba(36,_255,_0,_0.4)_0%,_rgba(0,_0,_0,_0)_100%_)] absolute h-full w-full" />
          <img
            src={combo.src}
            className="transform -rotate-[71.88deg] scale-x-[96.46%] scale-y-[34.74%] -translate-x-[78.4%] translate-y-[135.5%] origin-top-left absolute h-full w-full"
          />
          <div className="bg-[radial-gradient(rgba(82,_0,_255,_0.8)_0%,_rgba(0,_0,_0,_0)_100%)] absolute h-full w-full" />
          <img
            src={combo.src}
            className="transform rotate-[10.87deg] scale-x-[96.46%] scale-y-[34.74%] translate-x-[2.9%] -translate-y-[4.12%] origin-top-left absolute h-full w-full"
          />
          <div className="bg-[linear-gradient(_180deg,_rgba(255,_0,_0,_0.9)_0%,_rgba(0,_0,_0,_0)_100%_)] absolute h-full w-full" />
        </div>
      </div>
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[rgb(191,_43,_43)]" />
        ...
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[linear-gradient(rgba(5,_0,_255,_0.5),_rgba(5,_0,_255,_0.5)),_linear-gradient(rgba(255,_0,_0,_0.52),_rgba(255,_0,_0,_0.52))]" />
        <div className="w-[30px] h-[30px] flex-shrink-0 bg-[conic-gradient(_from_180deg,_rgba(36,_255,_0,_0.4)_0%,_rgba(0,_0,_0,_0)_100%_),_radial-gradient(rgba(82,_0,_255,_0.8)_0%,_rgba(0,_0,_0,_0)_100%),_linear-gradient(180deg,_rgba(255,_0,_0,_0.9)_0%,_rgba(0,_0,_0,_0)_100%)]" />
      ...
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        <div className="overflow-hidden relative w-[34px] h-[34px] flex-shrink-0 bg-[rgb(191,_43,_43)]">
          <p className="text-[rgb(255,_255,_255)] text-xs font-[Inter] font-normal">
            T
          </p>
        </div>
        <div className="overflow-hidden relative w-[34px] h-[34px] flex-shrink-0 bg-[rgb(191,_43,_43)]">
      ...
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <p className="whitespace-nowrap text-justify [filter:blur(1px)_drop-shadow(0px_4px_2px_rgba(255,_0,_0,_1))] text-[rgb(255,_255,_255)] text-[8px] font-[Arial] font-normal">
          Lorem{" "}
        </p>
      </div>
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
      ...
      <div className="flex items-center gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <img
          src={flipCrop.src}
          className="[box-shadow:0px_4px_4px_rgba(255,_255,_255,_1)] opacity-80 w-[32px] h-[40px] flex-shrink-0 object-cover border-solid border-[rgb(226,_19,_19)] border rounded-[8px]"
        />
        <img
          src={flipCrop.src}
      ...
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <Component
          override={{
            ...
            boxShadow: "0px 4px 4px  rgba(0, 255, 71, 1.00)",
            rotate: "38.9deg",
            overflow: "visible",
          }}
        />
