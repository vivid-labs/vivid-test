...
export const Root = ({ override }: { override?: any }) => {
  return (
    ...
    >
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap bg-[linear-gradient(_180deg,_rgb(255,_0,_0)_0%,_rgba(255,_255,_255,_0)_100%_),_conic-gradient(from_180deg,_rgb(0,_66,_255,_0.6)_0%,_rgba(0,_0,_0,_0)_100%),_radial-gradient(_rgb(0,_255,_41,_0.5)_0%,_rgba(0,_0,_0,_0)_100%,_rgba(0,_0,_0,_0)_100%_)] bg-clip-text text-justify text-[8px] font-normal text-transparent">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-[Times_New_Roman] font-normal text-white">
          Lorem
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal italic text-white">
          Lorem
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-bold text-white">
          Lorem
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-bold italic text-white">
          Lorem
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-base font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal tracking-[0.3em] text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal leading-[15px] text-white">
          Lorem
          <br />
          Ipsum
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal leading-[0px] text-white">
          Lorem
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white">
          Lorem
        ...
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white underline">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white line-through">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center whitespace-nowrap text-justify text-[8px] font-normal text-white">
          Lorem{" "}
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <p className="flex flex-col justify-center text-justify text-[8px] font-normal text-white">
          Lorem Ipsum{" "}
        </p>
        <p className="flex flex-col justify-center text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center overflow-hidden overflow-ellipsis text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col justify-center text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        ...
        <p className="text-justify text-[8px] font-normal text-white">Lorem </p>
        <p className="flex flex-col justify-center text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="flex flex-col text-justify text-[8px] font-normal text-white">
          Lorem{" "}
        </p>
        <p className="whitespace-nowrap text-justify text-[8px] font-normal text-white [filter:blur(1px)_drop-shadow(0px_4px_2px_rgb(255,_0,_0))]">
          Lorem{" "}
        </p>
      </div>
      <div className="relative flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <p className="flex flex-col justify-center text-center font-[Inter] text-[6px] font-semibold text-white">
          To prevent grouping
        </p>
      </div>
      ...
      <div className="flex flex-shrink-0 items-center gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        <div className="h-[27px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            className="h-full w-full origin-top-left translate-x-[0%] translate-y-[0%] scale-x-[100%] scale-y-[98.37%] transform"
            src={flipCrop.src}
          />
        </div>
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            className="h-full w-full origin-top-left translate-x-[142.86%] translate-y-[0%] scale-x-[25.93%] scale-y-[100%] transform"
            src={flipCrop.src}
          />
        </div>
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
        ...
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            className="h-full w-full origin-top-left translate-x-[60.37%] translate-y-[0%] scale-x-[109.91%] scale-y-[100%] transform"
            src={flipCrop.src}
          />
        </div>
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            className="h-full w-full origin-top-left -translate-x-[4.51%] -translate-y-[81.14%] scale-x-[109.91%] scale-y-[100%] transform"
            src={flipCrop.src}
          />
        </div>
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
        ...
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            className="h-full w-full origin-top-left -translate-x-[4.51%] translate-y-[0%] rotate-0 scale-x-[109.91%] scale-y-[100%] transform"
            src={flipCrop.src}
          />
        </div>
        <div className="h-[30px] w-[27px] flex-shrink-0 origin-top-left overflow-hidden">
