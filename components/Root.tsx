  ...
  return (
    ...
    >
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <p
          className="whitespace-nowrap bg-clip-text text-[8px] font-normal text-transparent"
          style={{
            background:
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <div
          className="h-[30px] w-[30px] flex-shrink-0 [rotate:-80.6deg]"
          style={{
            background:
              "linear-gradient(180deg, rgb(191, 43, 43) 0%, rgba(191, 43, 43, 0.00) 100%)",
          }}
        />
        <div
          className="h-[30px] w-[30px] flex-shrink-0 [rotate:123.5deg]"
          style={{
            background:
              "linear-gradient(180deg, rgb(191, 43, 43) 0%, rgba(191, 43, 43, 0.00) 100%)",
          }}
      ...
      <div className="flex flex-shrink-0 items-start gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        <div
          className="h-[30px] w-[30px] flex-shrink-0 [rotate:0deg]"
          style={{
            background:
              "linear-gradient(180deg, rgb(191, 43, 43) 0%, rgba(191, 43, 43, 0.00) 100%)",
          }}
        />
        <div
          className="h-[30px] w-[30px] flex-shrink-0 [rotate:50.6deg]"
          style={{
            background:
              "linear-gradient(180deg, rgb(191, 43, 43) 0%, rgba(191, 43, 43, 0.00) 100%)",
          }}
