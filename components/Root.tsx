    ...
    >
      ...
      <div className="flex items-center gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform translate-x-[60.37%] translate-y-[0%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform -translate-x-[4.51%] -translate-y-[81.14%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
        ...
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform rotate-0 -translate-x-[4.51%] translate-y-[0%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
