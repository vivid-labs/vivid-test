  ...
  return (
    ...
    >
      ...
      <div className="flex flex-shrink-0 items-center gap-[5px] rounded-sm border border-solid border-[rgb(75,_75,_75)] bg-[rgb(15,_15,_15)] p-[5px]">
        ...
        />
        <img
          className="h-10 w-8 flex-shrink-0 rounded-lg border border-solid border-[rgb(226,_19,_19)] object-cover opacity-80 [rotate:-9deg] [box-shadow:0px_4px_4px_rgb(255,_255,_255)]"
          src={flipCrop.src}
        />
        <img
