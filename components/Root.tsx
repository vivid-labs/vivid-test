    ...
    >
      ...
      <div className="flex items-center gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform translate-x-[142.86%] translate-y-[0%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform scale-x-[109.91%] scale-y-[16.85%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[26.58px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform rotate-[45.45deg] scale-x-[109.05%] scale-y-[18.66%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img src={flipCrop.src} className="origin-top-left h-full w-full" />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img src={flipCrop.src} className="origin-top-left h-full w-full" />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform rotate-[42.3deg] scale-x-[114.97%] scale-y-[104.61%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform rotate-[137.7deg] scale-x-[114.97%] scale-y-[104.61%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform scale-x-[114.97%] scale-y-[104.61%] origin-top-left h-full w-full"
          />
        </div>
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
        ...
        <div className="w-[27px] h-[29.68px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform scale-x-[40.31%] scale-y-[186.1%] translate-x-[35.17%] translate-y-[17.99%] origin-top-left h-full w-full"
          />
        </div>
      </div>
      <div className="flex items-center gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
        ...
        <div className="w-[27px] h-[27.45px] flex-shrink-0 origin-top-left overflow-hidden">
          <img
            src={flipCrop.src}
            className="transform rotate-[51.94deg] scale-x-[55.72%] scale-y-[84.75%] origin-top-left h-full w-full"
          />
        </div>
      </div>
      <div className="flex items-start gap-[5px] p-[5px] rounded-[2px] relative flex-shrink-0 border-solid border-[rgb(75,_75,_75)] border bg-[rgb(15,_15,_15)]">
