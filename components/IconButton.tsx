  ...
  if (style === "outlined" && state === "disabled") {
    return (
      <div
        ...
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full border-solid border-[rgba(29,_27,_32,_0.12)] border">
    ...
    return (
      <div
        ...
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full border-solid border-[rgb(121,_116,_126)] border">
          <div className="flex justify-center items-center p-2 bg-[rgba(73,_69,_79,_0.12)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      ...
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full border-solid border-[rgb(121,_116,_126)] border">
          <div className="flex justify-center items-center p-2 bg-[rgba(73,_69,_79,_0.08)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      <div
        ...
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgba(29,_27,_32,_0.12)]">
          <div className="flex justify-center items-center p-2">{icon}</div>
        </div>
      </div>
    );
    ...
    return (
      <div
        ...
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgb(232,_222,_248)]">
          <div className="flex justify-center items-center p-2 bg-[rgba(29,_25,_43,_0.12)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      ...
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgb(232,_222,_248)]">
          <div className="flex justify-center items-center p-2 bg-[rgba(29,_25,_43,_0.08)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      <div
        ...
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgb(103,_80,_164)]">
          <div className="flex justify-center items-center p-2 bg-[rgba(255,_255,_255,_0.12)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      ...
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgb(103,_80,_164)]">
          <div className="flex justify-center items-center p-2 bg-[rgba(255,_255,_255,_0.08)]">
            {icon}
          </div>
        </div>
      </div>
    ...
    return (
      <div
        className="flex flex-col justify-center items-center p-1 w-12 h-12"
        style={override}
      >
        <div className="overflow-hidden flex justify-center items-center rounded-full bg-[rgb(103,_80,_164)]">
          <div className="flex justify-center items-center p-2">{icon}</div>
