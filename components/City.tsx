...
export const City = ({
  ...
  return (
    <div
      ...
      className="overflow-hidden rounded-[20px] relative w-[94rem]"
    >
      <div className="overflow-hidden rounded-[20px] absolute w-[94rem] left-[0rem] h-[562px] top-[0rem] bg-[linear-gradient(_180deg,_rgb(255,_255,_255,_0.63)_0%,_rgb(0,_0,_0,_0)_100%_)]">
        {backgroundImage}
        <div className="absolute bg-[linear-gradient(_0deg,_rgb(13,_14,_16,_0.63)_0%,_rgb(217,_217,_217,_0)_100%_)]" />
      </div>
      <div
        style={contentSize}
        className="flex flex-col justify-between items-start pl-24 pr-24 pt-[34px] pb-[34px] absolute w-[94rem] left-[0rem] top-[0rem]"
      >
