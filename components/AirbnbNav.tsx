            ...
            <div className={styles.profileDropdown}>
              ...
              <div className={styles.avatar}>
                <div className={styles.avatarBase}>
                  <img src={iconImage1.src} className={styles.icon} />
                </div>
              </div>
            </div>
          </div>
