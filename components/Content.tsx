...
export const Content = ({ override }: { override?: any }) => {
  ...
  return (
    <div
      className="flex flex-col justify-center items-center px-[100px] py-[0rem] relative w-full flex-shrink-0 bg-white font-[Avenir]"
      style={override}
    >
      <div className="overflow-hidden flex justify-center items-center gap-2.5 p-0.5 relative w-full h-[519px] flex-shrink-0">
        ...
        <div className="overflow-hidden w-[100px] h-[100px] flex-shrink-0" />
