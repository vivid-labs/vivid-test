...
export const Content = ({ override }: { override?: any }) => {
  return (
    ...
    >
      ...
      <div className="absolute flex w-[581px] flex-col items-start justify-center gap-5 overflow-hidden rounded-[0.875rem] bg-white p-6 [box-shadow:0px_4px_10px_4px_rgba(0,_0,_0)]">
