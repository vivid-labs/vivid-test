import screenshot_2023_07_26At_2_42_2 from "./screenshot_2023_07_26At_2_42_2.png";
import { Logo } from "./Logo";
import { CtaButton } from "./CtaButton";
export const Frame_7 = ({ override }: { override?: any }) => {
  return (
    <div
      style={override}
      className="relative w-full h-[957px] flex-shrink-0"
      figma-id="14:13:9"
    >
      <p
        className="text-[rgb(255,_255,_255)] text-[14px] font-[Lato] font-bold"
        figma-id="14:13:8"
      >
        Maybe add some nice hover animation here to show that it&#x2019;s
        clickable
      </p>
      <div figma-id="14:13:10">
        <img
          src={screenshot_2023_07_26At_2_42_2.src}
          className="absolute w-[1635px] h-[957px] object-cover"
          figma-id="14:13:11"
        />
        <div
          className="absolute w-[399px] left-[1234px] h-[850px] top-[101px] bg-[rgb(255,_255,_255)]"
          figma-id="14:13:12"
        />
      </div>
      <div
        className="flex flex-col justify-between items-center absolute w-[401px] left-[1234px] h-[856px] top-[101px] bg-[rgb(255,_255,_255)]"
        figma-id="14:13:190"
      >
        <div
        ...
        >
          ...
          <p
            ...
            figma-id="14:13:41"
          >
            Please note that Rilla Chat is currently experimental and may
            produce inaccurate information about the conversation.
          </p>
        </div>
      </div>
      <div
        className="flex justify-center items-center gap-2 px-[12px] py-[10px] absolute left-[836px] top-[61px] bg-[linear-gradient(_160deg,_rgb(253,_185,_67,_1)_0%,_rgb(215,_113,_231,_1)_100%_)]"
        figma-id="14:13:176"
      >
        <Logo
          override={{
