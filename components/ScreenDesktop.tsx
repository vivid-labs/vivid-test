      ...
      <div className={styles.nftInfo}>
        <div className={styles.nftInfoDiv}>
          <div className={styles.headlineSubhead}>
            ...
            <p className={styles.mintedDate}>
              Minted on Sep 30, 2022
            </p>
          </div>
          <div className={styles.additionalInfo}>
            <div className={styles.creatorSection}>
              <p className={styles.creatorText}>Created By</p>
              <ArtistCard
            ...
            <div className={styles.description}>
              ...
              >
                ...
                blockchain,&#x2028;&#x2028;There are all sorts of beings in
                the NFT Universe. The most advanced and friendly of the bunch
                are Orbitians. &#x2028;&#x2028;They live in a metal space
            ...
            <div className={styles.details}>
              ...
              <div className={styles.websiteLink}>
                <Globe />
                <p className={styles.etherscanLink}>View on Etherscan</p>
              </div>
              <div className={styles.websiteLinkDiv}>
                <Globe />
                <p className={styles.originalLink}>View Original</p>
              </div>
            </div>
