  ...
  return (
    ...
    >
      ...
      <div className="relative w-[793px] h-[304px] flex-shrink-0">
        <p className="text-white text-[70px] font-bold tracking-[-0.03em]">
          Switzerland Has Never Been So Affordable
        </p>
        <p className="text-white text-[25px] font-normal tracking-[-0.03em]">
          Discover Switzerland. Choose the best programs, guides, hotels and
          restaurants.
        </p>
      </div>
      <Button color="White" />
      <div className="flex justify-center items-start gap-[31px] flex-shrink-0">
