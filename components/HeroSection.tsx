...
export const HeroSection = ({ override }: { override?: any }) => {
  return (
    ...
    >
      ...
      />
      <div className="relative w-[793px] h-[76rem] flex-shrink-0">
        <p className="text-center absolute w-[793px] left-[0rem] top-[0rem] text-[rgb(255,_255,_255)] text-[70px] font-[Quicksand] font-bold tracking-[-0.03em]">
