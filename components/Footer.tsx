...
export const Footer = ({ override }: { override?: any }) => {
  return (
    <div
      style={override}
      className="flex flex-col justify-between items-center p-60 relative w-[1440px] h-[417px] bg-[rgb(15,_33,_43)]"
    >
      <div className="flex flex-row justify-between items-start relative w-full h-[218px] flex-shrink-0">
        <div className="flex flex-col justify-start items-start gap-8 relative flex-shrink-0">
        ...
        <div className="flex flex-row justify-start items-center gap-80 relative flex-shrink-0">
          <div className="flex flex-col justify-start items-start gap-16 relative flex-shrink-0">
      ...
      <div className="flex flex-row justify-between items-center pt-28 relative w-full flex-shrink-0 border-t border-solid">
