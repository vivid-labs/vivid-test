...
export const TopPrograms = ({ override }: { override?: any }) => {
  return (
    <div
      style={override}
      className="flex flex-col justify-start items-center gap-[36px] pt-[56px] pb-[56px] relative w-[1440px] bg-[rgb(13,_17,_20)]"
    >
      ...
      <div className="flex flex-row justify-start items-start gap-[36px] relative flex-shrink-0">
        <City
          size="Large"
