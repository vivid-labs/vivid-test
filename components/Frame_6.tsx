...
export const Frame_6 = ({ override }: { override?: React.CSSProperties }) => {
  ...
  return (
    <div
      className="overflow-hidden flex flex-col items-center gap-4 px-8 py-4 rounded-lg w-full bg-white font-[Avenir]"
      style={override}
    >
      <img className="w-[42px] h-11 object-cover" src={logo.src} />
      <p className="text-black text-lg font-extrabold">Upgrade to Pro!</p>
      <p className="w-[304px] text-black text-sm font-normal">
        You&#x2019;ve reached the message limit for free users. With Pro:{" "}
      </p>
      <div className="flex flex-col items-start gap-1 w-[298px]">
