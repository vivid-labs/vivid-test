export const Button = ({
  ...
  return (
    ...
    >
      <p
        className="whitespace-nowrap text-center flex flex-col justify-center text-[rgb(255,_205,_41)] text-[16px] font-[Avenir] font-medium tracking-[0.01px] leading-[23px]"
        figma-id="8:1:257"
      >
        {text}
      </p>
