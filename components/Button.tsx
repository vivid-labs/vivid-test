...
export const Button = ({
  ...
  return (
    <div
      ...
      className="flex justify-center items-center gap-3 px-[50px] py-0 rounded-[20px] relative"
    ...
    >
      ...
      {hasText ? (
        <p
          ...
          className="whitespace-nowrap text-center text-[rgb(255,_255,_255)] font-[Work_Sans] font-semibold leading-[1.4em]"
