...
export const TopRatedArtists = ({ screen }: { screen: string }) => {
  switch (screen) {
    case "Desktop":
      return (
        <div className={styles.topRatedArtists0}>
    ...
    case "Tablet":
      return (
        <div className={styles.topRatedArtists11}>
    ...
    case "Mobile":
      return (
        <div className={styles.topRatedArtists22}>
