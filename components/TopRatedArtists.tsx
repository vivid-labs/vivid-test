    ...
    case "Desktop":
      return (
        <div style={style} className={styles.topRatedArtists}>
          <div className={styles.sectionHeadlineButton}>
    ...
    case "Tablet":
      return (
        <div style={style} className={styles.topRatedArtistsComponent}>
          <div className={styles.sectionHeadlineButtonDiv}>
            <div className={styles.sectionHeadlineDiv}>
              <div className={styles.headingDiv}>
                <p className={styles.topCreatorsDiv}>Top creators</p>
              </div>
              <div className={styles.subheadDiv}>
                <p
                  className={
                    styles.checkoutTopRatedCreatorsOnTheNftMarketplaceDiv
                  }
                >
                  Checkout Top Rated Creators on the NFT Marketplace
                </p>
    ...
    case "Mobile":
      return (
        <div style={style} className={styles.topRatedArtistsComponent1}>
          <div className={styles.sectionHeadlineButtonDiv1}>
            <div className={styles.sectionHeadlineDiv1}>
              <div className={styles.headingDiv1}>
                <p className={styles.topCreatorsDiv1}>Top creators</p>
              </div>
              <div className={styles.subheadDiv1}>
                <p
                  className={
                    styles.checkoutTopRatedCreatorsOnTheNftMarketplaceDiv1
                  }
                >
                  Checkout Top Rated Creators on the NFT Marketplace
                </p>
          ...
          <div className={styles.sectionHeadlineButtonDiv2}>
            <Button
              property_1="Secondary/Outlined"
              hasLeftIcon={true}
              leftIcon={<RocketLaunch />}
