...
export const Screen = ({ override }: { override?: React.CSSProperties }) => {
  return (
    <div className={styles.screenComponent} style={override}>
      ...
      <AnneliHasWorkedAtSeveralCompaniesThatProvideSoftwareAsAServiceSolutionsRecentlySheHelpedScaleASaaSProductFrom_3_500UsersToOver_100_000 />
      <p className={styles.operationalExpertise}>Operational Expertise</p>
      <SheIsCurrentlyManagingATeamOf20ItProfessionalsSheBuildThisTeamFromTheGroundUp />
    </div>
  );
};
...
const AISummary = () => (
  <div className={styles.frame_1}>
    ...
    <p className={styles.thisSummaryIsAiGeneratedAndMayNotBeEntirelyAccurate}>
    ...
    <div className={styles.summary}>
      ...
      >
        Anneli excels in managing technical teams, but she has less experience
...
const AnneliHasWorkedAtSeveralCompaniesThatProvideSoftwareAsAServiceSolutionsRecentlySheHelpedScaleASaaSProductFrom_3_500UsersToOver_100_000 =
  () => (
    <p
      className={
    ...
    >
      Anneli has worked at several companies that provide software-as-a service
      solutions. Recently, she helped scale a SaaS product from 3,500 users to
      over 100,000.
    </p>
  );

const SheIsCurrentlyManagingATeamOf20ItProfessionalsSheBuildThisTeamFromTheGroundUp =
  () => (
    <p
      className={
