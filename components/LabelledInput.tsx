...
export const LabelledInput = ({
  ...
  return (
    <div style={style} className={styles.lineSizeSmall}>
      <div className={styles.backgroundColorRgb_44_44_44} />
      <img src={imageSrc_0.src} style={lineSize_0} className={styles.line} />
