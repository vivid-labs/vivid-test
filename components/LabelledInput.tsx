...
export const LabelledInput = ({
  ...
  let divImageSrc;
  if (lineSize === "Small") {
    divImageSrc = vivid_9e75b58616ba;
  } else if (lineSize === "Medium") {
    divImageSrc = vivid_7a873c84aecb;
  } else {
    divImageSrc = vivid_0d71c74c9578;
  }

  return (
    <div style={style} className={styles.labelledInput}>
      <img src={divImageSrc.src} style={lineLineSize} className={styles.line} />
