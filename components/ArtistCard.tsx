      ...
      return (
        ...
        <div className={styles.artistInfo}>
          ...
          >
            ...
            <p className={styles.text_34_53Eth}>{salesNumber}</p>
          </div>
        </div>
        <div
          style={{
        ...
        >
          <p className={styles.text_1}>{rankingNumber}</p>
        </div>
       </div>)
      );
    case "Horizontal Big":
       ...
       (<div style={override} className={styles.artistCardComponent}>
        ...
        <div className={styles.artistInfoDiv}>
          ...
          >
            ...
            <p className={styles.text_34_53EthText}>{salesNumber}</p>
          </div>
        </div>
        <div
          style={{
        ...
        >
          <p className={styles.text_1Text}>{rankingNumber}</p>
        </div>
       </div>)
      );
    case "Horizontal Medium":
      return (
       (<div style={override} className={styles.artistCardComponent_1}>
        <Avatar property_1="Small" avatarPhoto={<Avatar_1 />} />
        <p className={styles.dishStudioText_1}>{artistName}</p>
       </div>)
      );
    case "Horizontal Small":
      return (
       (<div style={override} className={styles.artistCardComponent_2}>
        <Avatar property_1="Small" avatarPhoto={<Avatar_1 />} />
        <p className={styles.dishStudioText_2}>{artistName}</p>
       </div> 
      );
    default:
      return null;
