...
export const ArtistCard = ({
  ...
  switch (property_1) {
    case "Default":
      return (
        <div style={style} className={styles.artistCard0}>
    ...
    case "Horizontal Big":
      return (
        <div style={style} className={styles.artistCard9}>
    ...
    case "Horizontal Medium":
      return (
        <div style={style} className={styles.artistCard18}>
    ...
    case "Horizontal Small":
      return (
        <div style={style} className={styles.artistCard20}>
          <Avatar property_1="Small" avatarPhoto={<Avatar_1 />} style={{}} />
