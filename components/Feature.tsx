...
export const Feature = ({
  ...
  return (
    <div className="relative flex flex-col items-start pb-px" style={override}>
      <div className="relative flex flex-shrink-0 flex-col items-start gap-[7px] pb-0.5 pr-[103.53px]">
      ...
      <div className="relative flex w-full flex-shrink-0 items-start pr-[35.53px]">
