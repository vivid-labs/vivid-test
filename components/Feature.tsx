  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-start items-start pr-[35.53px] relative w-full flex-shrink-0">
        <p className="flex flex-col justify-center flex-shrink-0 flex-1 min-w-[0rem] text-[rgb(18,_18,_18)] text-[15px] font-[Avenir] font-normal tracking-[0.10125000029802322px] leading-[19px]">
          {description}
        </p>
      </div>
    </div>
