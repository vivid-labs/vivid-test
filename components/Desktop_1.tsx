...
export const Desktop_1 = ({ override }: { override?: any }) => {
  ...
  return (
    <div
      style={override}
      className="overflow-hidden flex flex-col items-start relative w-full h-[1024px] flex-shrink-0 bg-[rgb(255,_255,_255)]"
      figma-id="1:2"
    >
      <div
        className="overflow-hidden flex flex-row justify-between items-center px-[12px] py-0 relative w-full h-[69px] flex-shrink-0"
        figma-id="1:5"
      >
        <img
          src={logo.src}
          className="w-[42.09px] h-11 flex-shrink-0 object-cover opacity-100"
          figma-id="1:55"
        />
        <ProfilePicture />
      </div>
      <div
        className="flex flex-row items-start relative w-full flex-shrink-0 flex-1 min-h-[0rem]"
        figma-id="1:6"
      >
        <div
        ...
        <div
          className="overflow-hidden flex flex-col items-start relative h-full flex-shrink-0 flex-1 min-w-[0rem]"
          figma-id="1:3"
        >
          <div
            className="overflow-hidden flex flex-row items-center gap-[18px] px-[12px] py-[13px] relative w-full flex-shrink-0 bg-[rgb(242,_242,_242)]"
            figma-id="1:143"
          >
            <ProfilePicture />
            <p
          ...
          <div
            className="overflow-hidden flex flex-row items-center gap-3 p-3 relative w-full h-[62px] flex-shrink-0"
            figma-id="1:153"
          >
            <div
              className="overflow-hidden flex flex-row justify-between items-center pl-[20px] pr-[12px] py-[8px] rounded-[100px] relative flex-shrink-0 flex-1 min-w-[0rem] border-solid border-[rgb(193,_193,_193)] border"
              figma-id="1:157"
            >
              <p
              ...
              <div
                className="overflow-hidden flex flex-row justify-between items-center p-[2px] rounded-[100px] relative w-7 h-7 flex-shrink-0 bg-[rgb(69,_141,_247)]"
                figma-id="1:190"
              >
                <img
