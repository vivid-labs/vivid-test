...
export const Desktop_1 = ({ override }: { override?: any }) => {
  ...
  return (
    ...
    >
      <div
        className="overflow-hidden flex justify-between items-center px-[12px] py-0 relative w-full h-[69px] flex-shrink-0"
        figma-id="1:5"
      >
        <img
          src={logo.src}
      ...
      <div
        className="flex items-start relative w-full flex-shrink-0 flex-1 min-h-[0rem]"
        figma-id="1:6"
      >
        <div
