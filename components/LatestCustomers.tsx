...
export const LatestCustomers = ({ override }: { override?: any }) => {
  return (
    <div
      style={override}
      className="flex flex-col justify-start items-start gap-16 p-24 rounded-[16px] relative [box-shadow:0px_1px_3px_rgb(0,_0,_0,_0.1),_0px_1px_2px_rgb(0,_0,_0,_0.06)] w-[380.33px] bg-[rgb(255,_255,_255)]"
    >
      ...
      <div className="flex flex-col justify-start items-start relative w-full flex-shrink-0">
        <div className="overflow-hidden flex flex-row justify-start items-center pt-[9px] pb-[9px] relative w-full flex-shrink-0">
