        ...
        <div className={styles.nftInfo}>
          ...
          >
            <div className={styles.price}>
              ...
              <p className={styles.priceValue}>{priceNumber}</p>
            </div>
            <div className={styles.highestBid}>
              <p className={styles.highestBidText}>Highest Bid</p>
              <p className={styles.bidValue}>{bidNumber}</p>
            </div>
          </div>
        </div>
       </div>)
        ...
        <div className={styles.nftInfoDiv}>
          ...
          >
            <div className={styles.priceDiv}>
              ...
              <p className={styles.priceValue1}>{priceNumber}</p>
            </div>
            <div className={styles.highestBidDiv}>
              <p className={styles.highestBidText1}>Highest Bid</p>
              <p className={styles.bidValue1}>{bidNumber}</p>
            </div>
          </div>
        </div>
       </div> 
