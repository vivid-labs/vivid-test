        ...
        <div className="flex flex-col items-center gap-[72px] w-[1365px]">
          ...
          <div className="flex flex-col items-center gap-[72px] relative">
            ...
            <div className="w-[998px] h-[420px]">
              ...
              />
              <NYCOLORGamifyingUrbanExplorationInNewYorkCity />
              <NycolorLogo />
            </div>
          </div>
          <EnhancingAndroidShoppingCartExperience />
        </div>
      </div>
    </div>
  );
...
const RachelBio = () => (
  <div className="flex flex-col items-start gap-[18px] w-[996px]">
    <p className="text-black text-3xl font-bold">Hi, I&apos;m Rachel!</p>
    <p className="text-2xl font-normal">
      I&apos;m a UX Designer and senior at Columbia University studying computer
      science.
    </p>
  </div>
);

const EnhancingAndroidShoppingCartExperience = () => (
...
const InfiniteGoods = () => (
  <div className="w-[998px] h-[420px]">
    ...
    <div className="flex items-center gap-[165.3px] absolute left-[59.56px]">
      <div className="flex flex-col items-start gap-[0.66px]">
        <p className="text-black text-xl font-normal">INFINITE GOODS</p>
...
const NYCOLORGamifyingUrbanExplorationInNewYorkCity = () => (
  <div className="flex items-center gap-[165.3px] absolute left-[59.56px]">
    <div className="flex flex-col items-start gap-[0.66px]">
...
const NycolorLogo = () => (
  <div className="absolute w-[90px] left-[858.6px] h-[90px] top-[1786.8px] origin-top-left rounded-full overflow-hidden">
    <img
      ...
      style={{
        transform: "scale(109.75%, 108.29%) translate(-4.22%, -3.56%)",
      }}
      src={nycolorLogo.src}
    />
  </div>
