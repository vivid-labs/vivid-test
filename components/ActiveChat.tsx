...
export const ActiveChat = ({
  ...
  return (
    <div
      style={override}
      className="overflow-hidden flex flex-row items-center gap-[10px] p-3 relative w-[309px] border-solid border-[rgb(242,_242,_242)] border-b bg-[rgb(255,_255,_255)]"
      figma-id="1:9"
    >
      <ProfilePicture />
      <div
