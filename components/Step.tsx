      ...
      return (
        ...
        >
          ...
          <div className="flex flex-col items-start gap-[10px] relative flex-shrink-0 flex-1 min-w-[0rem]">
            <p className="flex flex-col justify-center text-[rgb(244,_86,_154)] text-[16px] font-[Avenir] font-black tracking-[0.01px] leading-[23px]">
              {task}
            </p>
            <p className="flex flex-col justify-center text-[rgb(148,_148,_148)] text-[14px] font-[Avenir] font-medium tracking-[0.01px] leading-[23px]">
              {time}
            </p>
          </div>
          <img
    ...
    case "Complete":
      return (
        ...
        >
          ...
          />
          <div className="flex flex-col items-start gap-[10px] relative flex-shrink-0 flex-1 min-w-[0rem]">
            <p className="flex flex-col justify-center text-[rgb(148,_148,_148)] text-[16px] font-[Avenir] font-black tracking-[0.01px] leading-[23px] line-through">
              {task}
            </p>
            <p className="flex flex-col justify-center text-[rgb(148,_148,_148)] text-[14px] font-[Avenir] font-medium tracking-[0.01px] leading-[23px]">
              {time}
        ...
        >
          ...
          <div className="flex flex-col items-start gap-[10px] relative flex-shrink-0 flex-1 min-w-[0rem]">
            <div className="flex items-start gap-[10px] relative w-full flex-shrink-0">
              <p className="whitespace-nowrap flex flex-col justify-center text-[rgb(148,_148,_148)] text-[16px] font-[Avenir] font-black tracking-[0.01px] leading-[23px]">
                {task}
              </p>
              <div className="overflow-hidden flex items-start px-[8px] rounded-[4px] relative flex-shrink-0 bg-[rgb(0,_0,_0)]">
                <p className="whitespace-nowrap flex flex-col justify-center text-[rgb(255,_255,_255)] text-[16px] font-[Avenir] font-medium tracking-[0.01px] leading-[23px]">
                  Coming Soon!
                </p>
              </div>
            </div>
