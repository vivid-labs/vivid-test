    ...
    case "Todo":
      return (
        <div
          ...
          style={override}
        >
          <RillaChatIntroduction />
          <TaskComponent task={task} time={time} />
          <img
    ...
    case "Complete":
      return (
        ...
        >
          ...
          />
          <TextContent task={task} time={time} />
        </div>
      );
    case "Unsupported":
      return (
        ...
        >
          <AiChatIntroduction />
          <TaskDescription task={task} time={time} />
        </div>
      );
    case "Up Next":
      return (
        ...
        >
          ...
          <AiChatIntroductionComponent task={task} time={time} />
        </div>
      );
    default:
      return null;
...
const TaskComponent = ({ task, time }: any) => (
  <div className="flex flex-col items-start gap-2.5 flex-1 min-w-0">
    <p className="w-full text-black text-base font-black tracking-[0.01px] leading-[23px]">
      {task}
    </p>
...
const TextContent = ({ task, time }: any) => (
  <div className="flex flex-col items-start gap-2.5 flex-1 min-w-0">
    <p className="w-full text-[rgb(148,_148,_148)] text-base font-black tracking-[0.01px] leading-[23px] line-through">
      {task}
    </p>
...
const TaskDescription = ({ task, time }: any) => (
  <div className="flex flex-col items-start gap-2.5 flex-1 min-w-0">
...
const AiChatIntroductionComponent = ({ task, time }: any) => (
  <div className="flex flex-col items-start gap-2.5 flex-1 min-w-0">
