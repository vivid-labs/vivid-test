    ...
    case "Todo":
      return (
        ...
        >
          ...
          <div className="relative flex min-w-0 flex-1 flex-shrink-0 flex-col items-start gap-2.5">
          ...
          <img
            className="h-[20.29px] w-5 flex-shrink-0 object-cover opacity-30"
            src={img_2585_1.src}
          />
        </div>
      );
    ...
    case "Unsupported":
      return (
        ...
        >
          ...
          <div className="relative flex min-w-0 flex-1 flex-shrink-0 flex-col items-start gap-2.5">
            <div className="relative flex w-full flex-shrink-0 items-start gap-2.5">
              ...
              <div className="relative flex flex-shrink-0 items-start overflow-hidden rounded bg-black px-2 py-[0rem]">
