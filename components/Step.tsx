      ...
      return (
        ...
        >
          <div className="relative w-14 h-14 flex-shrink-0" figma-id="8:29:374">
            <div
              className="absolute w-14 left-[0rem] h-14 top-[0rem] bg-[rgb(244,_86,_154)] rounded-[50%]"
              figma-id="8:27:167"
            />
            {icon}
          </div>
    ...
    case "Unsupported":
      return (
        ...
        >
          ...
          >
            <div
              className="absolute w-14 left-[0rem] h-14 top-[0rem] bg-[rgb(217,_217,_217)] rounded-[50%]"
              figma-id="8:223:167"
            />
            {icon}
          </div>
          ...
          >
            ...
            >
              ...
              <div
                className="overflow-hidden flex items-start gap-[10px] px-[8px] rounded-[4px] relative flex-shrink-0 bg-[rgb(0,_0,_0)]"
                figma-id="8:223:174"
              >
                <p
