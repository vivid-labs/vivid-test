...
export const Step = ({
  ...
  switch (status) {
    ...
    case "Unsupported":
      return (
        <div style={override} className={styles.stepComponent_1}>
        <div className={styles.frame_8Div}>
          <div className={styles.ellipse_3Div} />
          {icon}
        </div>
        <div className={styles.frame_7Div_1}>
          <div className={styles.frame_14}>
            <p className={styles.doThisTaskText_1}>{task}</p>
            <div className={styles.frame_13}>
              <p className={styles.comingSoonImportant}>Coming Soon!</p>
            </div>
          </div>
          <p className={styles.timeToDoThisTaskText_1}>{time}</p>
        </div>
       </div>)
      );
    case "Up Next":
      return (
       (<div style={override} className={styles.stepComponent_2}>
        <div className={styles.frame_8Div_1}>
          <div className={styles.ellipse_3Div_1} />
          {icon}
        </div>
        <div className={styles.frame_7Div_2}>
          <div className={styles.frame_38}>
            <p className={styles.doThisTaskText_2}>{task}</p>
            <div className={styles.frame_14Div}>
              <p className={styles.upNextImportant}>Up Next!</p>
            </div>
          </div>
          <p className={styles.timeToDoThisTaskText_2}>{time}</p>
        </div>
       </div> 
      );
    default:
