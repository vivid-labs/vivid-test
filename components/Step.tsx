    ...
    case "Todo":
      return (
        ...
        >
          ...
          <AiChatDisclaimer task={task} time={time} />
          <img
    ...
    case "Unsupported":
      return (
        ...
        >
          ...
          <TaskOverview task={task} time={time} />
        </div>
      );
    case "Up Next":
      return (
        ...
        >
          ...
          <AiChatIntroduction task={task} time={time} />
        </div>
      );
    default:
      return null;
...
const AiChatDisclaimer = ({ task, time }: any) => (
...
const TaskOverview = ({ task, time }: any) => (
  <div className="flex min-w-0 flex-1 flex-col items-start gap-2.5">
...
const AiChatIntroduction = ({ task, time }: any) => (
  <div className="flex min-w-0 flex-1 flex-col items-start gap-2.5">
