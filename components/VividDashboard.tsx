...
export const VividDashboard = ({ override }: { override?: any }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative flex h-full min-w-0 flex-1 flex-shrink-0 items-center bg-white px-[100px] py-10">
        <div className="relative flex h-[519px] min-w-0 flex-1 flex-shrink-0 items-center justify-center gap-12 overflow-hidden rounded-[5px] bg-white px-0.5 py-2.5">
          <div className="relative flex h-full min-w-0 flex-1 flex-shrink-0 flex-col items-start gap-6 px-2.5 pb-9 pt-7">
