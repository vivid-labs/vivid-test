...
export const VividDashboard = ({ override }: { override?: any }) => {
  ...
  return (
    <div
      style={override}
      className="flex items-start relative w-full h-[840px] flex-shrink-0 bg-[rgb(255,_255,_255)]"
      figma-id="8:29:575"
    >
      <SideBar
        style="Colored"
      ...
      />
      <div
        className="flex items-center gap-[10px] px-[100px] py-[40px] relative h-full flex-shrink-0 flex-1 min-w-[0rem] bg-[rgb(255,_255,_255)]"
        figma-id="8:29:577"
      >
        <div
