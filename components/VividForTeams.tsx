...
export const VividForTeams = ({ override }: { override?: any }) => {
  ...
  return (
    <div
      className="flex h-[800px] w-full flex-shrink-0 flex-col items-start bg-white font-[Avenir]"
      style={override}
    >
      <NavBar
        type="Colored"
      ...
      />
      <div className="flex min-h-0 w-full flex-1 flex-shrink-0 flex-col items-center justify-center bg-white px-[100px]">
        <div className="flex h-[583px] w-full flex-shrink-0 items-center justify-center gap-2.5 p-0.5">
          <div className="flex h-full min-w-0 flex-1 flex-shrink-0 flex-col items-start gap-[126px] px-2.5 pb-9 pt-7">
            <div className="flex w-full flex-shrink-0 flex-col items-start gap-[25px]">
            ...
            <div className="flex flex-shrink-0 items-start gap-3 pr-[389px]">
          ...
          <div className="relative h-[451px] w-[531px] flex-shrink-0 overflow-hidden rounded-br-[12px] rounded-tl-[7px] bg-[rgba(255,_255,_255,_0)] [box-shadow:0px_4px_18px_rgba(0,_0,_0,_0.3)]">
            <div className="absolute h-[450px] w-[666px] origin-top-left overflow-hidden">
              <img
