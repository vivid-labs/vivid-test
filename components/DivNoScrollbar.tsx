...
export const DivNoScrollbar = ({
  ...
  return (
    <div
      className="overflow-hidden flex items-start pt-8 w-full h-[990px] font-[Avenir]"
      style={override}
    >
      <div className="overflow-hidden flex flex-col items-start gap-7 pl-5 pr-[60px] py-5 rounded-[5px] h-full flex-1 min-w-0 bg-white">
        <GetStartedWithReplo />
        <FlexColumn stepProps={stepProps} />
      </div>
    </div>
  );
};
...
const FlexColumn = ({ stepProps }: any) => (
  <div className="flex justify-center items-center gap-12 w-full">
    ...
    <div className="overflow-hidden flex flex-col justify-center items-center rounded-[1.25rem] flex-1 min-w-0 bg-white">
      <img
