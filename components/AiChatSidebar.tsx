...
export const AiChatSidebar = ({ override }: { override?: any }) => {
  return (
    <div
      style={override}
      className="flex flex-col justify-between items-center relative w-full h-[856px] flex-shrink-0"
      figma-id="14:13:190"
    >
      <div
      ...
      >
        ...
        >
          ...
          <div
            className="flex items-start gap-[10px] px-[12px] py-[9px] rounded-[5px] relative [box-shadow:0px_0px_4px_rgb(190,_190,_190,_0.25)] flex-shrink-0 bg-[linear-gradient(_160deg,_rgb(253,_185,_67,_1)_0%,_rgb(215,_113,_231,_1)_100%_)]"
            figma-id="14:13:183"
          >
            <Logo
              override={{
      ...
      <div
        className="flex flex-col items-center gap-2 relative flex-shrink-0"
        figma-id="14:13:199"
      >
        <div
          className="rounded-[5px] w-[363px] h-[35px] flex-shrink-0 border-solid border-[rgb(209,_208,_209)] border relative"
          figma-id="14:13:184"
        />
        <p
