    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="flex flex-col justify-center items-center px-[8px] py-[16px] rounded-[10px] relative flex-shrink-0 border-solid border-[rgb(218,_218,_218)] border-2 bg-[linear-gradient(_180deg,_rgb(255,_255,_255,_0)_38.02083432674408%,_rgb(255,_255,_255,_0.5)_58.85416865348816%,_rgb(255,_255,_255,_1)_81.25%_)]"
              figma-id="14:13:179"
            >
              <p
                className="text-[rgb(0,_0,_0)] text-[14px] font-[Lato] font-normal"
        ...
        >
          <div
            className="flex items-start gap-1 relative w-full flex-shrink-0"
            figma-id="14:13:188"
          >
            <div
