...
export const AiChatSidebar = ({ override }: { override?: any }) => {
  return (
    <div className={styles.aiChatSidebarComponent} style={override}>
      ...
      <InaccurateInformationMsg />
    </div>
  );
};

const InaccurateInformationMsg = () => (
  <div className={styles.chat}>
    <div className={styles.chatInput} />
    <p className={styles.inaccurateInformationMsg}>
...
const HeaderBar = () => (
  <div className={styles.headerBar}>
    <p className={styles.diveDeeper}>Dive deeper with</p>
  ...
  <div className={styles.rillaAiChatIntroduction}>
    <div className={styles.heading}>
      <div className={styles.text}>
        <p className={styles.introducingRillaChat}>Introducing</p>
    ...
    <p className={styles.fromObjectionsToSalesRep}>
