    ...
    <div style={override} className={styles.aiChatSidebar} figma-id="5:186:164">
      <div className={styles.mainContent} figma-id="5:186:165">
        ...
        <div className={styles.chats} figma-id="5:186:171">
          <div className={styles.messageWrapper} figma-id="5:186:172">
            <div className={styles.initialChat} figma-id="5:186:173">
              <p
                className={styles.whatObjectionsShowedUpInThisConversationq}
                figma-id="5:186:174"
              >
          ...
          <div className={styles.messageWrapperDiv} figma-id="5:186:175">
            <div className={styles.teaser} figma-id="5:186:176">
              <p
                className={
                  styles.priceBudgetTheCustomerMentionedTheirInitialBudgetExpectationWasAround_10KSignificantlyLowerThanTheQuote
                }
                figma-id="5:186:177"
              >
              ...
              <p
                className={
                  styles.timingTheCustomerMentionedHavingOtherProjectsGoingOnAndWantingToThinkAboutTimingCashFlow
                }
                figma-id="5:186:178"
              >
          ...
          <div className={styles.frame_13} figma-id="5:186:179">
            <div className={styles.frame_15} figma-id="5:188:120" />
          </div>
        </div>
        <div className={styles.rillaAiChatIntroduction} figma-id="5:186:180">
          ...
          <p
            className={
              styles.fromObjectionsToWhereTheSalesRepWentOffScriptAiChatHasAnswersForAllYourQuestions
            }
            figma-id="5:186:187"
          >
      ...
      <div className={styles.chat} figma-id="5:186:189">
        ...
        <p
          className={
            styles.pleaseNoteThatRillaChatIsCurrentlyExperimentalAndMayProduceInaccurateInformationAboutTheConversation
          }
          figma-id="5:186:191"
        >
